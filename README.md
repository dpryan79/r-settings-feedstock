...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-settings-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-settings-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-settings-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-settings-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-settings-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-settings-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-settings/badges/version.svg)](https://anaconda.org/conda-forge/r-settings)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-settings/badges/downloads.svg)](https://anaconda.org/conda-forge/r-settings)
